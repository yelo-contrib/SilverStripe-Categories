...
silent only
cd ~/www/yh/categories/code
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 Categorized.php
badd +9 CategoryAdmin.php
badd +45 Category.php
badd +3 ../_config.php
silent! argdel *
edit Categorized.php
